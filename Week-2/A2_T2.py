...
# After user inputs, do print the car brand and model sentence with 
# two print commands using “sep” and “end” parameters.
...
#Car brand is "Toyota" and the model is 'Corolla'.T
print(f"Car brand is \"{Brand}\" ", end="")
print(f"and the model is", f"'{Model}'.", sep=" ")
#Program ending.
